                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                        <div>
                         ...
                         <div>
                            ...
                            <input name='basicSalary' type='number' required step="0.01" min='0' defaultValue={initialData?.basicSalary || 0} />
                        </div>

                        <div>
                            <label className='block mb-2'>Allowances</label>
                            <input name='allowances' type='number' required step="0.01" min='0' defaultValue={initialData?.allowances || 0} />
                        </div>

                        <div>
                            <label className='block mb-2'>Deductions</label>
                            <input name='deductions' type='number' required step="0.01" min='0' defaultValue={initialData?.deductions || 0} />
                        </div>
